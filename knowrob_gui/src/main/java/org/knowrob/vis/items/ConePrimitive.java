package org.knowrob.vis.items;

import javax.vecmath.Vector3f;

import org.knowrob.vis.Canvas;
import org.knowrob.vis.Drawable;
...
public class ConePrimitive implements Drawable {
	...
	protected org.knowrob.util.datastructures.Vector3f v1, v2;
	...
	public ConePrimitive(Vector3f v1, Vector3f v2, float r, float r2){
		...
		this.v1 = new org.knowrob.util.datastructures.Vector3f(v1);
		this.v2 = new org.knowrob.util.datastructures.Vector3f(v2);
	...
	public void draw(Canvas c) { 
		...
		c.pushMatrix();
			...
			org.knowrob.util.datastructures.Vector3f cp = new org.knowrob.util.datastructures.Vector3f();
			org.knowrob.util.datastructures.Vector3f yAxis = new org.knowrob.util.datastructures.Vector3f(0,1,0);
			cp.cross(dir, yAxis);
			
			if(cp.distance(new org.knowrob.util.datastructures.Vector3f(0,0,0)) != 0){
