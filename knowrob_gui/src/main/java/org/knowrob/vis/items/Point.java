...
public class Point implements Drawable {
	...
	public org.knowrob.util.datastructures.Vector3f v;
	public float size;
	public int color;
	
	public Point(float x, float y, float z, int color, float size) {
		this.v = new org.knowrob.util.datastructures.Vector3f(x,y,z);
		this.color = color;
		this.size = size;
	}
	...
	public void copyPos(Point p2) {
		v = new org.knowrob.util.datastructures.Vector3f(p2.v);
	}	
}
